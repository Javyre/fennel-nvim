...
require("fennel-nvim.lib.fennel").metadata:setall(view_quote, "fnl/arglist", {"str"})
...
require("fennel-nvim.lib.fennel").metadata:setall(escape, "fnl/arglist", {"str"})
local function sequence_key_3f(k, len)
  return ((type(k) == "number") and (1 <= k) and (k <= len) and (math.floor(k) == k))
end
require("fennel-nvim.lib.fennel").metadata:setall(sequence_key_3f, "fnl/arglist", {"k", "len"})
...
require("fennel-nvim.lib.fennel").metadata:setall(sort_keys, "fnl/arglist", {"a", "b"})
...
require("fennel-nvim.lib.fennel").metadata:setall(get_sequence_length, "fnl/arglist", {"t"})
...
require("fennel-nvim.lib.fennel").metadata:setall(get_nonsequential_keys, "fnl/arglist", {"t"})
...
require("fennel-nvim.lib.fennel").metadata:setall(count_table_appearances, "fnl/arglist", {"t", "appearances"})
local put_value = nil
...
require("fennel-nvim.lib.fennel").metadata:setall(puts, "fnl/arglist", {"self", "..."})
local function tabify(self)
  return puts(self, "\n", (self.indent):rep(self.level))
end
require("fennel-nvim.lib.fennel").metadata:setall(tabify, "fnl/arglist", {"self"})
local function already_visited_3f(self, v)
  return (self.ids[v] ~= nil)
end
require("fennel-nvim.lib.fennel").metadata:setall(already_visited_3f, "fnl/arglist", {"self", "v"})
...
require("fennel-nvim.lib.fennel").metadata:setall(get_id, "fnl/arglist", {"self", "v"})
...
require("fennel-nvim.lib.fennel").metadata:setall(put_sequential_table, "fnl/arglist", {"self", "t", "len"})
...
require("fennel-nvim.lib.fennel").metadata:setall(put_key, "fnl/arglist", {"self", "k"})
...
require("fennel-nvim.lib.fennel").metadata:setall(put_kv_table, "fnl/arglist", {"self", "t", "ordered-keys"})
...
require("fennel-nvim.lib.fennel").metadata:setall(put_table, "fnl/arglist", {"self", "t"})
...
require("fennel-nvim.lib.fennel").metadata:setall(_0_, "fnl/arglist", {"self", "v"})
put_value = _0_
local function one_line(str)
  local ret = str:gsub("\n", " "):gsub("%[ ", "["):gsub(" %]", "]"):gsub("%{ ", "{"):gsub(" %}", "}"):gsub("%( ", "("):gsub(" %)", ")")
  return ret
end
require("fennel-nvim.lib.fennel").metadata:setall(one_line, "fnl/arglist", {"str"})
...
require("fennel-nvim.lib.fennel").metadata:setall(fennelview, "fnl/arglist", {"x", "options"}, "fnl/docstring", "Return a string representation of x.")
return fennelview
